      ...
      },
      {
        ...
        Description: (
          <li className="mb-20" key={2}>
            <strong>Go over the answers.</strong> Read over the answers that was generated and add on.{" "}
            <Link>Learn how to start the patent process</Link>
          </li>
        ),
      },
      {
        ...
        Description: (
          <li className="mb-20" key={3}>
            ...
            Make the most of your resources and discover how our tool can streamline your legal processes <Link>Read more about patents here</Link>.
          </li>
        ),
      },
      
    ],
    links: ["Contact us", "Blog", "Feedback"],
  };
        ...
        >
          <Body className="bg-offwhite text-base font-sans">
            ...
            <Container className="bg-white p-45">
              ...
              <Link href="tangify.ai" className="no-underline">
